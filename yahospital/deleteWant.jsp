...
<div class="nav">
	...
	String deleteID  =  new String(getIDSting.getBytes("ISO-8859-1"),"utf-8");
	...
	try{
		...
		if(conn != null){
			...
			stmt = conn.prepareStatement(serchIdSQl);
			...
			if(isK){
			String sersql = "DELETE  FROM patientorder WHERE id=?";
	...
	<%
			//rs = stmt.executeQuery();
				...
				out.print("数据库中不存在输入的id的记录，请重新输入");
			}
		}
