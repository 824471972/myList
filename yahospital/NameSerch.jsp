...
<div class="nav">
	...
	String getNameSting = request.getParameter("name");
	String serchName  =  new String(getNameSting.getBytes("ISO-8859-1"),"utf-8");
	//String name = null;
	//int age = 1;
	...
	try{
		...
		if(conn != null){
			//out.print("数据库连接成功！\n");
			String sersql = "SELECT id,name,age,serverKind FROM patientorder WHERE name=?";
